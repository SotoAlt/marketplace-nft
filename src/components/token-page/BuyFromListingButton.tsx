...
import { type DirectListing, buyFromListing } from 'thirdweb/extensions/marketplace';
  ...
  return (
    <Button
      onClick={async () => {
        ...
        try {
          if (
            listing.currencyContractAddress.toLowerCase() !== NATIVE_TOKEN_ADDRESS.toLowerCase()
          ) {
